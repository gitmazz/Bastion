...
const HeroSection = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative py-60 flex items-center justify-center overflow-hidden"
    >
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Fast-track your SOC 2 certification with our expert team. We handle
            the complexity, you focus on growing your business.
          </p>
